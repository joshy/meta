...
VERSION = app.config['VERSION'] = '2.5.0'
...
SHOW_ANALYSIS_OPTIONS = app.config['SHOW_ANALYSIS_OPTIONS']
...
RIMA_URL = app.config['RIMA_URL']
RIMA_ANALYZE_URL = app.config['RIMA_ANALYZE_URL']
